  ...
  <div id="button-row">
      <div id="toggleView">
        <a href="<?php echo url_for('quake/map?id=3052276') ?>" class="c-button grey ui-corner-all">Map</a>
      </div>
      <div id="startForm">
        <a href="" class="c-button ui-corner-all orange">Share Information</a>
      </div>
    </div>
